...
import 'package:advicer_app/app/modules/home/presenter/drawer/savedadvices/saved_advices_view.dart';
...
class HomeModule extends Module {
  ...
  void binds(i) {
    ...
    i.addLazySingleton(SavedAdvicesController.new);
  }
  ...
  void routes(r) {
    ...
    r.child("/savedadvices",
        child: (context) => SavedAdvicesView(
              controller: Modular.get(),
            ));
  }
}
